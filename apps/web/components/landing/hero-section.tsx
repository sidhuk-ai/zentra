...
import { TextEffect } from "@workspace/ui/components/motion-primitives/text-effect";
import { AnimatedGroup } from "@workspace/ui/components/motion-primitives/animated-group";
import { HeroHeader } from "@/components/landing/header";
import { LogoCloud } from "@/components/landing/logo-cloud";
import AIAnimationEffect from "@workspace/ui/components/motion-primitives/ai-animation-effect"
        ...
        <section>
          <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
            <div className="relative z-10 mx-auto max-w-4xl text-center">
              ...
              >
                Empower Your Business With an AI Chatbot That Truly Understands Your Customers
              </TextEffect>
              <TextEffect
                per="line"
                preset="fade-in-blur"
              ...
              >
                Build, train, and deploy your own intelligent chatbot-engineered to answer website-specific queries with unmatched accuracy. Upload files, integrate with a simple script, and deliver relevant responses every time.
              </TextEffect>
